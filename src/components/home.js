      ...
      <div className="container-fluid">
        ...
        <div className="home-page" id="my-profile">
          ...
          <div className="mydetails right">
            <div className="logo">
              <ul>
                <a
                  title="links"
                  href="https://www.linkedin.com/in/raiyan-memon/"
                  target="_blank"
                ...
                <a
                  title="links"
                  href="https://github.com/Raiyan-Memon"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <li className="social-logo">
                ...
                <a
                  title="links"
                  href="//https://www.instagram.com/raiyan_memon"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <li className="social-logo">
            ...
            <div class="resume">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://drive.google.com/drive/folders/1LewSXTQYL-sh5qu7xeDieYtQpTAzpvtG?usp=sharing"
              >
                Resume
              </a>
              <a
                title="Download Resume"
                download="Raiyan's Resume"
                href={myResume}
              >
                <ion-icon
                  class="social-logo"
          ...
          <div className="scroll">
            <ul>
              <li>
                <a title="links" className="aboutmetext" href="#aboutme">
                  About Me
                </a>
              </li>
              <li>
