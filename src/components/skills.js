        ...
        <div className='container-fluid bg-black'>
            ...
            <div className='container  skill-list'>
                <div className='row text-bg-dark  text-center'>
                    <div className='col-md-2 mb-3 d-flex  justify-content-around flex-column shadow   col-6 '>
                    ...
                    <div className='col-md-2 mb-3 d-flex justify-content-around flex-column col-6 shadow'>
